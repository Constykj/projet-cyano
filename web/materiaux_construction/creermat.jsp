...
<html>
    ...
    <body>
        ...
        <h1>Creation Matériaux de construction </h1>

        <html:form action="creermat.do" method="post" >
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="bord">  <html:text property="lib_materiaux_construction" size="25"  /> </td>
