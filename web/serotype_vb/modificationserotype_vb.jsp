...
<html>
    ...
    <body>
        ...
        <h1>Modification serotype vibrionace</h1>
        <logic:present name="seroVb" >
            <html:form action="enregistreModifSerotypeVb.do" method="post">
             
                <table>
                    <html:hidden  property="idserotype_vb"  name="seroVb"  /> 
                    <tr> 
                        <td class="bord">  <bean:message key="serotype_vb.designation"/> </td>
                        <td class="bord">  <html:text property="design_serotype" size="25" name="seroVb"  />   </td>
                    </tr>
                
                     <tr>
                        <td class="bord">  <bean:message key="serotype_vb.visible"/>  </td>
                        <td class="bord">
                            <html:select property="visible" name="seroVb">    
