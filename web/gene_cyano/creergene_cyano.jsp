...
<html>
    ...
    <body>
        ...
        <h1>Creation Gene Cyano </h1>

        <html:form action="creationGeneCyano.do" method="post" >
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="bord">  <html:text property="design_gene_cyano" size="25"  /> </td>
