...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function Chiffres(name) {
                var nn = name.value;
                // alert(nn);
                if (nn != "" && nn != "0.0" && !/^.[0-9]+$/.test(name.value)) {
            ...
            function NumEch() {
                ...
                var url = "/Cyano1/numeroEchan.do";
                new Ajax.Request(url, {
                    parameters: {num_echan: document.getElementById("echan").value},
                    onSuccess: function (transport, json) {
                        if (json.error) {
                            alert(json.error);
                        }
                        else {
                            var resu = json.num_echantillon;
                            //   alert("dans if   "+resu);
                            if (document.getElementById("echan").value === resu)
                                document.getElementById("resultat").value = "Ce numero existe deja";
                            // alert("dans cond   ")
                        }
                    }
                });
    ...
    <body onbeforeunload="alertSortie()">
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr> 
                                            ...
                                            <td class="bord"> 
                                                <html:select property="idpoint_prelevement" styleId="pp"  onchange="doAjaxPost()">    
                                ...
                                <fieldset  >
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bord"> <input type="text" size="25" id="sp_gps_lat"  disabled="true" />  </td>
                                        </tr>

                                        <tr>
                                            <td class="bord"> Longitude </td>
                                            <td class="bord"> <input type="text" size="25" id="sp_gps_long" disabled="true"   />  </td>
                                        </tr>
                                    </table>
                                </fieldset>
                            </div>
...
<!--
                        <div style=" float: left">
                            <div id="mapcrea" style="width: 440px; height: 450px; border: 1px solid
...
-->
                    ...
                    <div>               
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="bord"> <html:text property="num_echan" size="17"   styleId="echan"  onblur="effaceNum()" onchange="NumEch()" /> </td>
                                <td class="bord"> <input type="text" id="resultat" disabled="true"/> </td>
                            </tr>
                            <tr>
                                <td class="bord"> <bean:message key="crea.date_prev"/> </td>
                                <td class="bord"> <input type="date" name="date_creat" width="25"/> </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div id="div2">               
                        <table>
                            <tr>
                                ...
                                <td class="bord"> <html:text property="phosphore" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.nitrate"/> </td>
                                <td class="bord"> <html:text property="nitrate" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.couleur_eau_brute"/> </td>
                                <td class="bord"> <html:text property="couleur_eau_brute" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.phosphate"/> </td>
                                <td class="bord">  <html:text property="phosphate" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.chlorophyle"/> </td>
                                <td class="bord"> <html:text property="chlorophyle_a" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.potentiel_redox"/> </td>
                                <td class="bord"> <html:text property="potentiel_redox" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.azote"/> </td>
                                <td class="bord"> <html:text property="azote_totale" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu">      </td>
                                <td class="bord">  <bean:message key="crea.tubidite"/> </td>
                                <td class="bord"> <html:text property="tubidite" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.amminium"/> </td>
                                <td class="bord"> <html:text property="amminium" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.oxygene"/> </td>
                                <td class="bord"> <html:text property="oxygene_dissout" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu">  </td>
                                <td class="bord">  <bean:message key="crea.fer"/> </td>
                                <td class="bord"><html:text property="fer" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />  </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.MES"/> </td>
                                <td class="bord"> <html:text property="MES" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.transparence"/> </td>
                                <td class="bord"> <html:text property="transparence" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu">      </td>
                                <td class="bord">  <bean:message key="crea.codium"/> </td>
                                <td class="bord"> <html:text property="cadmium" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.hydrogene_sulfure"/> </td>
                                <td class="bord"> <html:text property="hydrogene_sulfure" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.ph"/> </td>
                                <td class="bord"> <html:text property="ph" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">       </td>
                                <td class="bord">  <bean:message key="crea.plomb"/> </td>
                                <td class="bord"><html:text property="plomb" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.COT"/> </td>
                                <td class="bord"> <html:text property="COT" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.temparature"/> </td>
                                <td class="bord"> <html:text property="temperature" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">    </td>
                                <td class="bord">  <bean:message key="crea.selenium"/> </td>
                                <td class="bord"><html:text property="seleniuml" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.DCO"/> </td>
                                <td class="bord"> <html:text property="DCO" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                ...
                                <td class="bord"> <html:text property="nickel" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.DBO5"/> </td>
                                <td class="bord"> <html:text property="DBO5" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.salinite"/> </td>
                                <td class="bord"> <html:text property="salinite" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.arsenic"/> </td>
                                <td class="bord"> <html:text property="arsenic" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                                <td class="milieu">     </td>
                                <td class="bord">  <bean:message key="crea.manganese"/> </td>
                                <td class="bord"> <html:text property="manganese" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.conductivite"/> </td>
                                <td class="bord"><html:text property="conductivite" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />  </td>
                                <td class="milieu">  </td>
                                <td class="bord">  <bean:message key="crea.zinc"/> </td>
                                <td class="bord"><html:text property="zinc" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>

                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.cuivre"/> </td>
                                <td class="bord"> <html:text property="cuivre" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  />  </td>
                                <td class="milieu">   </td>
                                <td class="bord">  Mercure </td>
                                <td class="bord"><html:text property="mercure" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />  </td>
                            </tr>
                        ...
                        <fieldset>
                            ...
                            <table id="tbgrc"  >                                
                                <tr id="grc1">
                                    ...
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy1" >    
                                    ...
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy1"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy1"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" onfocus="sommeEspCyano()" />     </td>
                                </tr>
                                <tr id="grc2">
                                    <td id="cpgrc">2</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy2" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy2"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy2"   onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  onfocus="sommeEspCyano()" />   </td>
                                </tr>
                                <tr id="grc3">
                                    <td id="cpgrc">3</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy3" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy3"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy3"   onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"   onfocus="sommeEspCyano()" />   </td>
                                </tr>
                                <tr id="grc4">
                                    <td id="cpgrc">4</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy4" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy4"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy4"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  onfocus="sommeEspCyano()" />   </td>
                                </tr>
                                <tr id="grc5">
                                    <td id="cpgrc">5</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy5" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy5"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy5"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  onfocus="sommeEspCyano()" />    </td>
                                </tr>
                                <tr id="grc6">
                                    <td id="cpgrc">6</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy6" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy6"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy6"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  onfocus="sommeEspCyano()" />     </td>
                                </tr>
                                <tr id="grc7">
                                    <td id="cpgrc">7</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy7" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy7"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy7" onfocus="sommeEspCyano()"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  />     </td>
                                </tr>
                                <tr id="grc8">
                                    <td id="cpgrc">8</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy8" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy8"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy8" onfocus="sommeEspCyano()"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  />     </td>
                                </tr>
                                <tr id="grc9">
                                    <td id="cpgrc">9</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy9" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy9"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy9" onfocus="sommeEspCyano()" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />     </td>
                                </tr>
                                <tr id="grc10">
                                    <td id="cpgrc">10</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="sel_genre_cy10" >    
                                            <html:options collection="genrecya_trouve" property="idgenre_cyano" labelProperty="design_genre_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="sel_esp_cy10"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="text_genre_cy10" onfocus="sommeEspCyano()"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />     </td>
                                </tr>
                            </table>
                        </fieldset>
                        <fieldset>
                            ...
                            <table id="tbgnc" >
                                <tr id="gnc1">
                                    ...
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano1"  >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano1"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> 
                                </tr>  
                                <tr id="gnc2">
                                    <td id="cpgnc">2</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano2"   >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano2"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr> 
                                <tr id="gnc3">
                                    <td id="cpgnc">3</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano3"   >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano3"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr> 
                                <tr id="gnc4">
                                    <td id="cpgnc">4</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano4"   >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano4"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr> 
                                <tr id="gnc5">
                                    <td id="cpgnc">5</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano5"   >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano5"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="gnc6">
                                    <td id="cpgnc">6</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano6"  >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano6" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> 
                                </tr>  
                                <tr id="gnc7">
                                    <td id="cpgnc">7</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano7"  >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano7" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> 
                                </tr>  
                                <tr id="gnc8">
                                    <td id="cpgnc">8</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano8"  >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano8" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> 
                                </tr>  
                                <tr id="gnc9">
                                    <td id="cpgnc">9</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano9"  >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano"  /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano9" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> 
                                </tr> 
                                <tr id="gnc10">
                                    <td id="cpgnc">10</td>
                                    <td>/ &nbsp;</td>
                                    <td> Gene Cyano</td>
                                    <td> 
                                        <html:select property="idgene_cyano"  styleId="gene_cyano10"  >    
                                            <html:options collection="genecya_trouve" property="idgene_cyano" labelProperty="design_gene_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano10" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> 
                                </tr>  
                            </table>
                            <br/>
                            <hr/>
                            ...
                            <table id="tbtgt"  >
                                ...
                                <tr id="tgt1">
                                    ...
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite1" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite1" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt2">
                                    <td id="cptgt">2</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite2" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite2" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt3">
                                    <td id="cptgt">3</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite3" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite3" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt4">
                                    <td id="cptgt">4</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite4" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite4" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt5">
                                    <td id="cptgt">5</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite5" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite5" onchange="PerdFocus()" onblur="Chiffres25(this)"/> </td>
                                </tr>
                                <tr id="tgt6">
                                    <td id="cptgt">6</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite6" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite6" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt7">
                                    <td id="cptgt">7</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite7" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite7" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt8">
                                    <td id="cptgt">8</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite8" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite8" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt9">
                                    <td id="cptgt">9</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite9" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite9" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                                <tr id="tgt10">
                                    <td id="cptgt">10</td>
                                    <td>/ &nbsp;</td>
                                    <td> Type de gene de toxicite</td>
                                    <td> 
                                        <html:select property="idtyp_gene_toxicite"  styleId="gene_toxicite10" >    
                                            <html:options collection="typegenetox_trouve" property="idtyp_gene_toxicite" labelProperty="design_typ_gene_toxicite" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite10" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                </tr>
                            </table>
                        </fieldset>
                        <fieldset>
                            ...
                            <table id="tbtt" >
                                ...
                                <tr id="tt1">
                                    ...
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine1" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine1" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt2">
                                    <td id="cptt">2</td>
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine2" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine2" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                ...
                                <tr id="tt3">
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine3" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine3" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                ...
                                <tr id="tt4">
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine4" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine4" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                ...
                                <tr id="tt5">
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine5" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine5" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt6">
                                    <td id="cptt">6</td>
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine6" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine6" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt7">
                                    <td id="cptt">7</td>
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine7" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine7" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt8">
                                    <td id="cptt">8</td>
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine8" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine8" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt9">
                                    <td id="cptt">9</td>
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine9" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine9" onchange="PerdFocus()" onblur="Chiffres39(this)"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt10">
                                    <td id="cptt">10</td>
                                    ...
                                    <td> Type de toxicite</td>
                                    <td> 
                                        <html:select property="idtype_toxine"  styleId="type_toxine10" >    
                                            <html:options collection="typetoxine_trouve" property="idtype_toxine" labelProperty="design_toxine" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine10" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                            </table>
                        </fieldset>
                    ...
                    <div id="div4">               
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="bord"> <html:text property="coliforme_tx" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                                <td class="milieu" >    </td>

                                <td class="bord"> <bean:message key="crea.echerichiacoli"/>   </td>
                                <td class="bord">  <html:text property="e_coli" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.califormeth"/> </td>
                                <td class="bord"> <html:text property="coliforme_thermo" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td  class="milieu">     </td>

                                <td class="bord">   <bean:message key="crea.streptocoquefecaux"/> </td>
                                <td class="bord">   <html:text property="streptocoques_fecaux" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord"> <bean:message key="crea.anaerobisulforecl"/>  </td>
                                <td class="bord">  <html:text property="anaerobie_sulfo_red" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">   </td>

                                <td class="bord"> Autre salmonelle  </td>
                                <td class="bord"><html:text property="autre_salm" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                            </tr>
                            <tr>
                                <td class="bord">  Salmonelle </td>
                                <td class="bord"> <html:text property="salmonelle" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                                <td class="milieu"> </td>

                                <td class="bord"> <bean:message key="crea.srotypesalmonelle"   /> </td>
                                <td class="bord"> 
                                    <html:select property="serotype_salm" >    
                            ...
                            <tr>
                                ...
                                <td class="bord">  <html:text property="vibrio" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/> </td>
                                <td class="milieu">  </td>
                                <td class="bord"><bean:message key="crea.serotypevibriocholerae"/> </td>
                                <td class="bord">
                                    <html:select property="serotype_vibrio" >    
                                        <html:option value="1">Present</html:option> 
                                        <html:option  value="0">Absent</html:option>
                                    </html:select> </td>
                            </tr>
                    ...
                    <div id="div5">   
                        ...
                        <table id="tbaa"  name="tbaa" >
                            <tr id="aa1" name="aa1" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg1" onchange="doAjaxPost1()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" cols="30" rows="3" disabled="true" styleId="ta_genre1"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                <tr id="aa2" name="aa2" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg2" onchange="doAjaxPost2()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" disabled="true" cols="30" rows="3" styleId="ta_genre2"  > </html:textarea>  </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg3" onchange="doAjaxPost3()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" disabled="true" cols="30" rows="3" styleId="ta_genre3"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg4" onchange="doAjaxPost4()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" disabled="true" cols="30" rows="3" styleId="ta_genre4"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                <tr id="aa5" name="aa5" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg5" onchange="doAjaxPost5()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" disabled="true" cols="30" rows="3" styleId="ta_genre5"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                <tr id="aa6" name="aa6" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg6" onchange="doAjaxPost6()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" cols="30" rows="3" disabled="true" styleId="ta_genre6"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                <tr id="aa7" name="aa7" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg7" onchange="doAjaxPost7()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" cols="30" rows="3" disabled="true" styleId="ta_genre7"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                <tr id="aa8" name="aa8" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg8" onchange="doAjaxPost8()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" cols="30" rows="3" disabled="true" styleId="ta_genre8"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                <tr id="aa9" name="aa9" >
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg9" onchange="doAjaxPost9()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" cols="30" rows="3" disabled="true" styleId="ta_genre9"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                                ...
                                <td> 
                                    <html:select property="idfamille"  styleId="famalg10" onchange="doAjaxPost10()"  >    
                                        <html:options collection="famille_trouve" property="idfamille" labelProperty="design_famille" /> 
                                    </html:select>
                                </td>
                                <td style="width: 100px">&nbsp; </td>
                                <td><html:textarea property="genreAlgue" cols="30" rows="3" disabled="true" styleId="ta_genre10"  > </html:textarea> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td></td>
                                </tr>
                            </table>
                        ...
                        <div id="div6">               
                            <table>
                                <tr>
                                    ...
                                    <td class="bord"> 
                                    <html:select property="enterovirus">    
                    ...
                    <div id="div7">               
                        <table>
                            <tr> 
                                ...
                                <td class="bord"> <html:text property="cryptosporidium" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />  </td>
                            </tr>
                            <tr> 
                                <td class="bord">  <bean:message key="crea.giardia"/> </td>
                                <td class="bord"> <html:text property="giardia" size="25" onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);" />   </td>
                            </tr>
                            <tr> 
                                <td class="bord">  <bean:message key="crea.helminthe"/> </td>
                                <td class="bord"> <html:text property="helminthe" size="25"  onchange="PerdFocus(this)" onblur="Chiffres(this);verif(this);"/>  </td>
                            </tr>
        ...
        <table class="pied">
            <tr>
                <td colspan="2"  class="bord">  <html:submit  onclick="disableBeforeUnload()" value="Sauvegarder" onfocus="selectGenreCyano();selectGeneCyano();selectTypeGeneToxicite();selectTypeToxine();selectAutreAlgue();" /> &nbsp;
