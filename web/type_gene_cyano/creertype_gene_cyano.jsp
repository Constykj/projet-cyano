...
<html>
    ...
    <body>
        ...
        <h1>Creation Type Gene Cyano </h1>

        <html:form action="creationTypeGeneCyano.do" method="post" >
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="bord">  <html:text property="design_typ_gene_cyano" size="25"  /> </td>
                    <td class="bord"> <font class="error">   <html:errors property="desigerror" /></font>  </td>
                </tr>
                <tr>
                    <td class="bord">  <bean:message key="type_gene_cyano.conc"/> </td>
                    <td class="bord">  <html:text property="conc_typ_gene_cyano" size="25"  /> </td>
                    <td class="bord"> <font class="error">   <html:errors property="desigerror" /></font>  </td>
                </tr>
