    ...
    <body>
        ...
        <html:form action="creaaction.do" method="post" >
                    ...
                    <div>               
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="bord"> <html:text property="num_echan" size="17"    /> </td>
                            </tr>
                            <tr>
                    ...
                    <div id="div2">               
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="bord"> <html:text property="cuivre" size="25"  />  </td>
                                <td class="milieu">   </td>
                ...
                <fieldset>
                    ...
                    <div id="div3">               
                        <fieldset>
                            ...
                            <input type="button" value="Ajouter une nouvelle ligne"  id="clonetrigger"   />  <input type="button" value="Supprimer"  id="bgrc_s"    />
                            <html:hidden property="listeGenreCyano"  styleId="listeGenreCya"    value ="" />
                            <table id="tbgrc"  >                                
                                <tr id="grc1" class="clonable" >
                                    <td id="cpgrc">1</td>
                                    <td>/ &nbsp;</td>
                                    <td> Genre Cyano</td>
                                    <td> 
                                        <html:select property="idgenre_cyano"  styleId="selGenreCy_1" >    
                                    ...
                                    <td> Espece Cyano</td>
                                    <td>   
                                        <html:select property="idespece_cyano"  styleId="selEspCy_1"   >    
                                            <html:options collection="espececya_trouve" property="idespece_cyano" labelProperty="design_espece_cyano" /> 
                                        </html:select>
                                    </td>
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="denombrement_esp_cyano" styleId="textGenreCy_1" />     </td>
                                </tr>
                        ...
                        <fieldset>
                            ...
                            <table id="tbgnc" >
                                <tr id="gnc1">
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano1" /> 
                                </tr>  
                                <tr id="gnc2">
                                    <td id="cpgnc">2</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano2"  /> </td>
                                </tr> 
                                <tr id="gnc3">
                                    <td id="cpgnc">3</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano3"  /> </td>
                                </tr> 
                                <tr id="gnc4">
                                    <td id="cpgnc">4</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano4"  /> </td>
                                </tr> 
                                <tr id="gnc5">
                                    <td id="cpgnc">5</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano5"  /> </td>
                                </tr>
                                <tr id="gnc6">
                                    <td id="cpgnc">6</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano6" /> 
                                </tr>  
                                <tr id="gnc7">
                                    <td id="cpgnc">7</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano7" /> 
                                </tr>  
                                <tr id="gnc8">
                                    <td id="cpgnc">8</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano8" /> 
                                </tr>  
                                <tr id="gnc9">
                                    <td id="cpgnc">9</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano9" /> 
                                </tr> 
                                <tr id="gnc10">
                                    <td id="cpgnc">10</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text  property="concentration_gene_cyano"  styleId="nb_gene_cyano10" /> 
                                </tr>  
                            </table>
                            <br/>
                            <hr/>
                            ...
                            <table id="tbtgt"  >
                                ...
                                <tr id="tgt1">
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite1" /> </td>
                                </tr>
                                <tr id="tgt2">
                                    <td id="cptgt">2</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite2" /> </td>
                                </tr>
                                <tr id="tgt3">
                                    <td id="cptgt">3</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite3" /> </td>
                                </tr>
                                <tr id="tgt4">
                                    <td id="cptgt">4</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite4" /> </td>
                                </tr>
                                <tr id="tgt5">
                                    <td id="cptgt">5</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite5" /> </td>
                                </tr>
                                <tr id="tgt6">
                                    <td id="cptgt">6</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite6" /> </td>
                                </tr>
                                <tr id="tgt7">
                                    <td id="cptgt">7</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite7" /> </td>
                                </tr>
                                <tr id="tgt8">
                                    <td id="cptgt">8</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite8" /> </td>
                                </tr>
                                <tr id="tgt9">
                                    <td id="cptgt">9</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite9" /> </td>
                                </tr>
                                <tr id="tgt10">
                                    <td id="cptgt">10</td>
                                    <td>/ &nbsp;</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_gene_toxicite" styleId="nb_gene_toxicite10" /> </td>
                                </tr>
                            </table>
                        </fieldset>
                        <fieldset>
                            ...
                            <table id="tbtt" >
                                ...
                                <tr id="tt1">
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine1" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt2">
                                    <td id="cptt">2</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine2" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                ...
                                <tr id="tt3">
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine3" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                ...
                                <tr id="tt4">
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine4" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                ...
                                <tr id="tt5">
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine5" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt6">
                                    <td id="cptt">6</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine6" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt7">
                                    <td id="cptt">7</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine7" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt8">
                                    <td id="cptt">8</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine8" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt9">
                                    <td id="cptt">9</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine9" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                                <tr id="tt10">
                                    <td id="cptt">10</td>
                                    ...
                                    <td style="width: 100px">&nbsp; </td>
                                    <td>Denombrement </td>
                                    <td><html:text property="concentration_type_toxicite" styleId="nb_type_toxine10" /> </td>
                                    <td style="width: 100px">&nbsp; </td>
                                </tr>
                            </table>
                        </fieldset>
                    ...
                    <div id="div4">               
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="bord"> <html:text property="coliforme_tx" size="25"  /> </td>
                                <td class="milieu" >    </td>

                                <td class="bord"> <bean:message key="crea.echerichiacoli"/>   </td>
                                <td class="bord">  <html:text property="e_coli" size="25"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord">  <bean:message key="crea.califormeth"/> </td>
                                <td class="bord"> <html:text property="coliforme_thermo" size="25"  /> </td>
                                <td  class="milieu">     </td>

                                <td class="bord">   <bean:message key="crea.streptocoquefecaux"/> </td>
                                <td class="bord">   <html:text property="streptocoques_fecaux" size="25"  /> </td>
                            </tr>
                            <tr>
                                <td class="bord"> <bean:message key="crea.anaerobisulforecl"/>  </td>
                                <td class="bord">  <html:text property="anaerobie_sulfo_red" size="25"  /> </td>
                                <td class="milieu">   </td>

                                <td class="bord"> Autre salmonelle  </td>
                                <td class="bord"><html:text property="autre_salm" size="25"  />  </td>
                            </tr>
                            <tr>
                                <td class="bord">  Salmonelle </td>
                                <td class="bord"> <html:text property="salmonelle" size="25"  />  </td>
                                <td class="milieu"> </td>
                            ...
                            <tr>
                                ...
                                <td class="bord">  <html:text property="vibrio" size="25"  /> </td>
                                <td class="milieu">  </td>
            ...
            <div>
                ...
                <div >
                    <select id="genre_algue1" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre1()"></select>
                    <select id="genre_algue2" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre2()"></select>
                    <select id="genre_algue3" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre3()"></select>
                    <select id="genre_algue4" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre4()"></select>
                    <select id="genre_algue5" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre5()"></select>
                    <select id="genre_algue6" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre6()"></select>
                    <select id="genre_algue7" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre7()"></select>
                    <select id="genre_algue8" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre8()"></select>
                    <select id="genre_algue9" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre9()"></select>
                    <select id="genre_algue10" multiple="true" hidden="" style="margin-left: 300px" ondblclick="dbGenre10()"></select>
                </div>
                <br/>
                <hr/>
                <br/>
        ...
        <table class="pied">
            <tr>
                <td colspan="2"  class="bord">  <html:submit value="Sauvegarder" onfocus="selectGenreCyano();selectGeneCyano();selectTypeGeneToxicite();selectTypeToxine();selectAutreAlgue();"/> <html:reset /> &nbsp;
