 ...
 */
package com.pasteur.ci.point_prelevement.dao;
...
public class PointPrelevementDAOImplement implements BaseDAO {
    ...
    private static final String SQL_SELECT = "select idpoint_prelevement,profondeur,idstat,visible from point_prelevement where idpoint_prelevement = ? ";
    private static final String SQL_SELECT_ALL = "select idpoint_prelevement,designation,idstat,profondeur,visible from point_prelevement";
    private static final String SQL_CREATE = "insert into point_prelevement (profondeur,idstat,visible) values (?,?,?)";
    private static final String SQL_UPDATE = "update point_prelevement set profondeur = ? , idstat= ? ,visible = ? where idpoint_prelevement = ?" ;
