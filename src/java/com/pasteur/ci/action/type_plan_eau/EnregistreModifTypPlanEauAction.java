 ...
 * @author Abouchou
 */
public class EnregistreModifTypPlanEauAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String idtype_plan_eau =  (String) PropertyUtils.getProperty(form, "idtype_plan_eau");       
        ...
        quartier.setIdtype_plan_eau(Integer.valueOf(idtype_plan_eau));
