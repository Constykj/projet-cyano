 ...
 * @author Abouchou
 */
public class EnregistreModifEclairageAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
         String ideclairage =  (String) PropertyUtils.getProperty(form, "ideclairage");       
        ...
        eclairage.setIdeclairage(Integer.valueOf(ideclairage));
