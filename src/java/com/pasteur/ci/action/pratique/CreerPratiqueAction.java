 ...
 * @author Abouchou
 */
public class CreerPratiqueAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        PratiqueDAOImplement pradaoi = new PratiqueDAOImplement(DAOFactory.getInstance());
        pradaoi.create(pratiques);
