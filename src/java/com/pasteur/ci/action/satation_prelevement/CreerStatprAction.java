 ...
 * @author Abouchou
 */
public class CreerStatprAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        int idhab = (Integer) PropertyUtils.getProperty(form, "idhabitat");
