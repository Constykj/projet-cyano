 ...
 * @author abouchou
 */
public class EnregistreModifSerotypeSalAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
       ...
       SerotypeSal serotype_sal = new SerotypeSal();
        ...
        serotype_sal.setDesign_serotype(design_serotype);
        serotype_sal.setVisible(visible);


       SerotypeSalDAOImplement rdaoi = new SerotypeSalDAOImplement(DAOFactory.getInstance());
        rdaoi.update(serotype_sal);
