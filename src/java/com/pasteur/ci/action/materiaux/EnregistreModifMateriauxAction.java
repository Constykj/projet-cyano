 ...
 * @author Abouchou
 */
public class EnregistreModifMateriauxAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String idmateriaux_construction = (String) PropertyUtils.getProperty(form, "idmateriaux_construction");
        ...
        materiaux_construction.setIdmateriaux_construction(Integer.valueOf(idmateriaux_construction));
        ...
        cdaoi.update(materiaux_construction);
