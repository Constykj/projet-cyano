 ...
 * @author Abouchou
 */
public class ModifiCyanoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
         String  Id = (String) PropertyUtils.getProperty(form, "idcyano");

            Cyanobacterie cyanobacterie = new Cyanobacterie();
            cyanobacterie.setIdcyano(Integer.valueOf(Id));

            CyanobacterieDAOImplement udaoi = new CyanobacterieDAOImplement(DAOFactory.getInstance());

            cyanobacterie = (Cyanobacterie) udaoi.find(cyanobacterie);

            request.setAttribute("cyano_trouve", cyanobacterie);
